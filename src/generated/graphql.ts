...
export type MutationResolvers<ContextType = any, ParentType = ResolversTypes['Mutation']> = {
  createUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, MutationCreateUserArgs>,
  createMessage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, MutationCreateMessageArgs>,
};
